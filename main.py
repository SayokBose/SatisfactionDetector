...
satisfaction_data = pd.DataFrame(columns=['Timestamp', 'Emotion', 'Satisfaction'])  # Include 'Timestamp' column
...
while True:
    ...
    for (x, y, w, h) in faces:
        ...
        # Assuming satisfaction is a random number between 0 and 1
